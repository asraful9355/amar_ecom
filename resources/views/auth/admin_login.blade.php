			...
			<div class="col-12">
				<div class="row justify-content-center no-gutters">
					<div class="col-lg-4 col-md-5 col-12">
                        ...
                        <p class="text-warning">{{ Session::get('error-msg')}}</p>
                        @endif
                            ...
                            @csrf
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="text" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Username" name="email">
									</div>
								</div>
                                @error('email')
